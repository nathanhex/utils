...
/**
 * AES Encryption Utility<br/> In order to support 256 key length, download JCE for java8 from the
 * following URL, and extract the jar files from the zip and save them in
 * ${java.home}/jre/lib/security/: http://www.oracle.com/technetwork/java/javase/downloads/jce8-download-2133166.html
 *
 * @author nathan
 */
public class AES {
     ...
     */
    private static byte[] AES256_ZERO_IV =
    ...
    public static String decrypt(String key, String initVector, String encrypted) {
        byte[] decrypted =
                decrypt(Enc.decode64(key), Enc.decode64(initVector), Enc.decode64(encrypted));
